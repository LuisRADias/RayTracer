...
public:
     ...
     */
    Vector3(double m_x = 0.0f, double m_y = 0.0f, double m_z = 0.0f);
     ...
     */
    inline double getSqrLength() const
    {
        return x*x + y*y + z*z;
    }
     ...
     *	@return	returns the multiplication
     */
    friend Vector3  operator * (const Vector3 & v, const double & b)
    {
     ...
     *	@return	returns the multiplication
     */
    friend Vector3  operator * (const double & b, const Vector3 & v)
    {
        return Vector3 (v.x * b, v.y * b, v.z * b);
    }
...
public:
     ...
     */
    Vector4(double m_x = 0.0f, double m_y = 0.0f, double m_z = 0.0f, double m_w = 1.0f);
     ...
     */
    Vector4 & operator*= (const double & m);
     ...
     */
    friend Vector4  operator * (const Vector4 & v, const double & b)
    {
     ...
     *	@return	returns the vector multiplied by the constant
     */
    friend Vector4  operator * (const double & b, const Vector4 & v)
    {
        return Vector4 (v.x * b, v.y * b, v.z * b, v.w * b);
    }
};
